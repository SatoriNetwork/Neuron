...
class DataManager:
    ...
    def runPublisher(self, models):
        ...
        for model in models:
            ...
            self.listeners.append(model.predictionUpdated.subscribe(
...
class ModelManager:
    ...
    def runPredictor(self, data):
        ...
        self.modelUpdated.subscribe(
            lambda x: makePredictionFromNewModel() if x and self.model != None else None)
        self.inputsUpdated.subscribe(
            lambda x: makePredictionFromNewInputs() if x and self.model != None else None)
    ...
    def runExplorer(self):
        ...
        self.newAvailableInput.subscribe(
            lambda x: explore(x) if x is not None else None)
